	...
	render() {
		return (
				<div className="col-lg-12 col-md-12 col-sm-12 col-xs-12">
					...
					<div className="col-lg-12 col-md-12 col-sm-12 col-xs-12">
						<h3 className="text-center propertyHaedText">My Properties</h3>
					</div>
					{
									...
									<div className="col-lg-9 col-md-9 col-sm-12 col-xs-12 ">				
										...
										<div className="col-lg-12 col-md-12 col-sm-12 col-xs-12 myPropertiesInternal mt20">				
											...
											<div className="col-lg-4 col-md-4 col-sm-12 col-xs-12 pull-right">				
												<button className="btn pull-right btn-primary">Details<img className="btnImg" src="/images/TGK-key.png"/></button>
											</div>
										</div>
									</div>
								</div>
