			...
			<div className="container-fluid">
				<div className="col-lg-10 col-lg-offset-1 col-md-10 col-sm-12 col-xs-12 noPad About1 ">
					...
					<div className="col-lg-8 col-lg-offset-2  About3">
						<p><b>LYVO</b> is a market disrupting Real Estate Brokerage ONLINE-OFFLINE business portal, which is aimed at addressing a number of key issues in the REAL Estate Brokerage Markets such as price discrepancy, services (or lack of), integrity, trust and transparency.</p>
						<p>LYVO Team is a mix of professionals from different walks for life.</p>
