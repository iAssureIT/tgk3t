	...
	render() {
		return (
			<div className="container-fluid">
				<div className="col-lg-10 col-lg-offset-1 col-md-10 col-sm-10 col-xs-10 noPad About1 ">
					<h3 className="col-lg-3 col-lg-offset-2 About2 noPad">ABOUT US</h3>
					<hr className="col-lg-10 col-lg-offset-1" />
					<div className="col-lg-8 col-lg-offset-2 noPad About3">
