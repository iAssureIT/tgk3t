...
*/
    ...
    console.log("mod",mod)
		return (
			<div className="col-lg-12 col-md-8 col-sm-8 col-xs-8 noPad">
            ...
            null
                  ...
                  if(mod === 2){
                            ...
                            <div  className="col-lg-12 oneProp">
                              <div className="row">
                                <div id=" bgImg" className="imgZoom" >
                                   <img alt="" src={'/images/photo1.jpeg'} className="col-lg-12 noPad imgSize zoom" />
                                </div>
                                <div id="info1" >
                                  RESIDENTIAL TOWER
                                </div>
                              ...
                              <div className="col-lg-5 mt10 row ">
                                <i className="fa fa-map-marker"></i> {property.propertyLocation  ? property.propertyLocation.area+", "+property.propertyLocation.city:"-"}
                              </div>
                              ...
                              <div className=" col-lg-12 row">
                                <div className=" col-lg-9 row">
                                  ...
                                  <div className="pull-left mt10"> Ready To Move{/*property.status*/} </div>
                                </div>
                    ...
                    return(
                      <div id="index" key={index} className="mt10 col-lg-4">
                        <div  className="col-lg-12 oneProp">
                          <div className="row">
                            <div id=" bgImg" className="imgZoom" >
                               <img alt="" src={"/images/photo2.jpeg"} className="col-lg-12 noPad imgSize zoom" />
                            </div>
                            <div id="info1" >
                              RESIDENTIAL TOWER
                            </div>
                      ...
                      return(
                      	<div id="index" key={index} className="mt10 col-lg-4 col-lg-offset-4">
                            <div className="col-lg-12 oneProp">
                              <div className="row">
                                <div id=" bgImg" className="imgZoom" >
                                   <img alt="" src={"/images/photo3.jpeg"} className="col-lg-12 noPad imgSize zoom" />
                                </div>
                                <div id="info1" >
                                  RESIDENTIAL TOWER
                                </div>
                              ...
                              <div className="col-lg-5 mt10 row ">
                                <i className="fa fa-map-marker"></i> {property.propertyLocation ? property.propertyLocation  ? property.propertyLocation.area+", "+property.propertyLocation.city:"-" :"-"}
                              </div>
                              <div className="pull-left col-lg-12 row  ">
                                <h4><b> {property.propertyLocation && property.propertyLocation ?property.propertyLocation.society:"-".length > 0 ?property.propertyLocation ?property.propertyLocation.society:"-":"-"} </b></h4>
                              </div>
                              <div className=" col-lg-12 row">
                                <div className=" col-lg-9 row">
                                  <h4 className="pull-left"><span> Bed {property.propertyDetails  ? property.propertyDetails.bedrooms :"-"}</span> <span>Baths {property.propertyDetails  ? property.propertyDetails.bathrooms : "-"}</span> </h4>
                    ...
                    return(<div key={index} id="index" className="mt10 col-lg-4">
                            <div  className="col-lg-12 oneProp">
                              <div className="row">
                                <div id=" bgImg" className="imgZoom" >
                                   <img alt="" src={"/images/photo4.jpeg"} className="col-lg-12 noPad imgSize zoom" />
                                </div>
                                <div id="info1" >
                                  RESIDENTIAL TOWER
                                </div>
                              ...
                              <div className="col-lg-5 mt10 row ">
                                <i className="fa fa-map-marker"></i> {property.propertyLocation}
                              </div>
                              <div className="pull-left col-lg-12 row  ">
                                <h4><b> {property.propertyLocation ?property.propertyLocation.society:"-"} </b></h4>
                              </div>
                  ...
                  return(<div id="index" key={index} className="mt10 col-lg-4">
                            <div  className="col-lg-12 oneProp">
                              <div className="row">
                                <div id=" bgImg" className="imgZoom" >
                                   <img alt="" src={"/images/photo5.jpeg"} className="col-lg-12 noPad imgSize zoom" />
                                </div>
                                <div id="info1" >
                                  RESIDENTIAL TOWER
                                </div>
