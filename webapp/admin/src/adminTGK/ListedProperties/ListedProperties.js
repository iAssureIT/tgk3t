...
class ListedProperties extends Component {
    ...
    listed(event){
        ...
        swal({
          title: "Are you sure?",
          text: "You want to remove listed property!",
          icon: "warning",
          className: "confirmSwal",
          buttons: [
            'No, cancel it!',
        ...
        .then(isConfirm =>{
          if(isConfirm) {  
                        ...
                        axios
                            ...
                            .then(resultData =>{
                                ...
                                if(resultData.data){
                                    ...
                                    swal({
                                      title: 'Listed Removed!',
                                      text: 'Property removed from listed!',
                                      icon: 'success'
                                    }) 
                                }
                            })
                ...
                swal("Cancelled", "Property remove from listed cancelled!", "error");
          }
        })    
    }
        ...
        return (
        	<div className="col-lg-12 col-md-12 col-xs-12 col-sm-12 noPad">
                <div className="col-lg-12 col-md-12 col-xs-12 col-sm-12 text-center noPad">
                    <h2>List of Listed Properties</h2>
                </div>
                                    ...
                                    <div className="col-lg-12 col-md-12 col-sm-12 col-xs-12 myPropertiesInternal">              
                                        ...
                                        <div className="col-lg-12 col-md-12 col-sm-12 col-xs-12 myPropertiesInternal mt20">             
                                            ...
                                            <div className="col-lg-2 col-md-4 col-sm-12 col-xs-12">              
                                                ...
                                                <div className="col-lg-2 col-md-4 col-sm-12 col-xs-12">              
                                                    <button className="btn bg-red pull-right" id={result._id} onClick={this.listed.bind(this)}>Remove Listed</button>
                                            </div>
                                            <div className="col-lg-2 col-md-4 col-sm-12 col-xs-12">              
                                                <button className="btn bgDelete" id={result._id} onClick={this.deleteProperty.bind(this)}><i className="fa fa-trash"></i> Delete</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
